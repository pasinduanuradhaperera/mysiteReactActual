...
const Navbar = () => {
  ...
  return (
    <div className=' flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4 text-white'>
        <h1 className='w-full text-3xl font-bold  text-[#32f8ff]'>PASINDU</h1>
        ...
        <h1 className='w-full text-3xl font-bold text-white mx-4 mt-8'>PASINDU</h1>
        ...
        <ul className='uppercase p-4'>
          ...
          <li className='p-4 font-bold border-b border-gray-600'>Projects</li>
          <li className='p-4 font-bold'>Contact</li>
        </ul>
        </div>
    </div>
